...
class Simulator4:
    def __init__(self, dirichlet, price_matrix, arms_configuration, min_user, max_user, distributions, slot_matrix, lambda_):
        ...
        :param min_user: minimum number of users per day
        :param max_user: maximum number of users per day
        ...
        number_users = random.randint(min_user, max_user)
        count = 0
        self.users = []
