...
class Simulator2:
    def __init__(self, dirichlet, price_matrix, arms_configuration, number_users, distributions, slot_matrix, lambda_):
        ...
        :param distributions: matrix of the different distributions for the different type of users
    ...
    def run(self):
        ...
        for count in range(len(webpages)):
            if useful_users[count].buy(webpages[count], 10):
                i = 0
